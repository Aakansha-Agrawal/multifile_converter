...
def protect(path, save_file):
    ...
    def get_data():
        ...
        if(get_passwrd_1 == get_passwrd_2):
            ...
            save_files = save_file.replace("\\","/")
            saveasfile = os.path.join(save_files, "{0}_protected.pdf".format(savefile_format(path)))
            print(save_file)
...
save_file = 'E:\\Project_Files'
protect(path,save_file)